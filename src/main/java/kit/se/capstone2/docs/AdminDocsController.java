...
public interface AdminDocsController {
	...
	@ApiResponse(responseCode = "200", description = "성공")
	CommonResponse<Page<AdminResponse.ConfirmationLawyer>> getConfirmationLawyers(
			@RequestParam int page, @RequestParam int size
	);


	@Operation(summary = "변호사 승인 상세 조회")
	@ApiResponse(responseCode = "200", description = "성공")
	CommonResponse<AdminResponse.ConfirmationLawyerDetails> getConfirmationLawyerDetails(
	...
	public CommonResponse<AdminResponse.ConfirmationLawyer> confirmLawyer(
			Long id,
			AdminRequest.Confirmation request
	);
}
